                    ...
                    <form action="{{ route('editLibro', $libro->id)}}" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="form-row">
                                ...
                                <div class="col-md-5 mb-4">
                                    ...
                                    <input type="text" name="fecha_apertura" class="form-control" value="{{$libro->fecha_apertura}}" required >
                                </div>
                            </div>
                            ...
                            <div class="form-row">
                                <div class="col-md-5 mb-4">
                                    ...
                                    <input type="text" name="nombre_autor" class="form-control" value="{{$libro->nombre_autor}}"  required>
                                </div>

                                <div class="col-md-5 mb-4 ">
                                    <label for="nuero">Numero Serie</label>
                                    <input type="number" name="numro_serie" class="form-control" value="{{$libro->numro_serie}}" required>
                                </div>
                            </div>
